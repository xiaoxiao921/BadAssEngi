...
namespace BadAssEngi.Skills.Secondary.OrbitalStrike.EngiStates
{
	public class FireOrbitalMines : BaseState
	{
		...
		public override void OnEnter()
		{
			...
			if (isAuthority)
			{
				ProjectileManager.instance.FireProjectile(BaeAssets.EngiOrbitalMinePrefab, aimRay.origin,
